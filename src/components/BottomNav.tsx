...
export function BottomNav() {
  ...
  return (
    ...
    >
      <div
        className={`mx-auto flex ${SCREEN_WIDTH} items-start justify-between px-1 pt-2 pb-[calc(env(safe-area-inset-bottom)+8px)] sm:rounded-3xl sm:border sm:border-line sm:bg-surface sm:px-4 sm:pt-3 sm:pb-3 sm:shadow-tile`}
      >
